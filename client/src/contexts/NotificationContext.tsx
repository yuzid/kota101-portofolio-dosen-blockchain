...
export interface Notification {
  id: string;
  type: 'document' | 'activity' | 'conflict' | 'member_added' | 'approval' | 'reminder' | 'system';
  title: string;
  description: string;
  actor?: string;
  timestamp: string;
    ...
    dosen: [
      {
        ...
        description: 'Admin TU Siti Aminah telah mendistribusikan dokumen "SK Mengajar Semester Genap 2025/2026" kepada Anda.',
      ...
      },
      {
        ...
        description: 'Dr. Ahmad Fauzi menambahkan Anda sebagai anggota pada kegiatan "Penelitian Blockchain dalam Pendidikan".',
      ...
      },
      {
        ...
        description: 'Data kegiatan "Mata Kuliah Pemrograman Web" telah diperbarui oleh Dr. Ahmad Fauzi (anggota).',
        actor: 'Dr. Ahmad Fauzi',
      ...
      },
      {
        ...
        description: 'Terjadi konflik data pada kegiatan "Pengabdian Masyarakat Desa Cikoneng" — selesaikan sebelum dapat mengedit.',
      ...
      },
      {
        ...
        description: 'Batas waktu pengumpulan laporan kegiatan penelitian "AI in Education" adalah 3 hari lagi.',
    ...
    admin_tu: [
      {
        ...
        description: 'Dokumen "SK Mengajar Semester Genap 2025/2026" berhasil didistribusikan ke 25 dosen.',
        timestamp: '2026-05-16T09:15:00',
        isRead: false,
      ...
      },
      {
        ...
        description: 'Dokumen "Surat Tugas Penelitian Q2" berhasil tercatat di blockchain dengan hash 0x7f8a...',
    ...
    kaprodi: [
      {
        ...
        description: 'Dr. John Doe menambahkan kegiatan "Mata Kuliah Pemrograman Web" (Pengajaran - D4 TI).',
        actor: 'Dr. John Doe',
      ...
      },
      {
        ...
        description: 'Dr. Ahmad Fauzi memperbarui kegiatan "Penelitian Blockchain" (Penelitian - D4 TI).',
        actor: 'Dr. Ahmad Fauzi',
      ...
      },
      {
        ...
        description: 'Kegiatan "Workshop AI untuk Mahasiswa" membutuhkan persetujuan Anda.',
    ...
    kajur: [
      {
        ...
        type: 'activity',
        title: 'Kegiatan Baru Ditambahkan',
        description: 'Dr. Siti Nurhaliza menambahkan kegiatan "Pengabdian Masyarakat" (Pengabdian - D3 TI).',
        actor: 'Dr. Siti Nurhaliza',
...
export function NotificationProvider({ children, userRoles }: { children: ReactNode; userRoles?: string[] }) {
